...
// console.log(Object.keys(products))   // all the keys in the form of array
console.log(Object.keys(products).length>0)   // all the keys in the form of array
// console.log(Object.values(products)) // all the values in the form of array
console.log(Object.values(products).length>0) // all the values in the form of array
