let users = [
    { "eid": 1, "name": "Eden", "email": "evamplew0@dmoz.org", "gender": "Female" },
...
//             rows = rows + `<tr><td>${emp.eid}</td> <td> ${emp.name}</td> <td> ${emp.email}</td> <td>${emp.gender}</td> </tr>`
//         }
//         document.getElementById('one', 'two').innerHTML = rows
//     }
// }

// function display_Male() {
//     row = "";
//     for (let emp of users) {
//         if (emp.gender === "Male") {
//             row = row + `<tr><td>${emp.eid}</td> <td> ${emp.name}</td> <td> ${emp.email}</td> <td>${emp.gender}</td> </tr>`
//         }
//         document.getElementById('two').innerHTML = row
//     }
// }
function display_data() {
    let female_emp = "";
    ...
    document.getElementById('one').innerHTML = female_emp
    document.getElementById('two').innerHTML = male_emp
    document.getElementById('three').innerHTML = other_emp
}